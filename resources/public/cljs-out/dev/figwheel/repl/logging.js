...
try{return cljs.core.reduce.call(null,cljs.core._PLUS_,cljs.core.map.call(null,cljs.core._STAR_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(100000000000),(10000),(1)], null),cljs.core.map.call(null,(function (p1__57897_SHARP_){
return parseInt(p1__57897_SHARP_);
}),cljs.core.take.call(null,(3),clojure.string.split.call(null,v,/[^\d]/)))));
}catch (e57898){if((e57898 instanceof Error)){
var e = e57898;
...
var c_57900 = (new goog.debug.Console());
var G__57899_57901 = c_57900.getFormatter();
goog.object.set(G__57899_57901,"showAbsoluteTime",false);

goog.object.set(G__57899_57901,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_57900);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__57902_SHARP_){
return goog.object.get(goog.debug.Logger.Level,p1__57902_SHARP_);
