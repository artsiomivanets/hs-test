...
var G__48747 = o;
goog.object.set(G__48747,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__48751 = o;
goog.object.set(G__48751,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__48752__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__48753__i < G__48753__a.length) {G__48753__a[G__48753__i] = arguments[G__48753__i + 0]; ++G__48753__i;}
  args = new cljs.core.IndexedSeq(G__48753__a,0,null);
} 
...
var args = cljs.core.seq(arglist__48754);
...
var G__48755 = props;
var G__48755__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__48755,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__48755);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__48755__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__48756 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__48756,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__48756;
}
})(),id_class);
...
var G__48757 = (cljs.core.count.call(null,argv) - first_child);
switch (G__48757) {
case (0):
...
var vec__48759 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__48759,(0),null);
var id = cljs.core.nth.call(null,vec__48759,(1),null);
var className = cljs.core.nth.call(null,vec__48759,(2),null);
...
var temp__5757__auto___48762 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___48762 == null)){
} else {
var key_48763 = temp__5757__auto___48762;
(jsprops.key = key_48763);
}
...
var temp__5757__auto___48764 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___48764 == null)){
} else {
var key_48765 = temp__5757__auto___48764;
(jsprops.key = key_48765);
}
...
var temp__5757__auto___48766 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5757__auto___48766 == null)){
} else {
var key_48767 = temp__5757__auto___48766;
(jsprops.key = key_48767);
}
...
var temp__5757__auto___48768 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___48768 == null)){
} else {
var key_48769 = temp__5757__auto___48768;
(jsprops.key = key_48769);
}
...
var temp__5757__auto___48770 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___48770 == null)){
} else {
var key_48771 = temp__5757__auto___48770;
(jsprops.key = key_48771);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__48772_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__48772_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__48773 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__48773,(0),null);
var derefed = cljs.core.nth.call(null,vec__48773,(1),null);
...
break;
default:
var G__48778 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__48779 = compiler;
v = G__48778;
compiler = G__48779;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template48783 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template48783 = (function (opts,id,fn_to_element,meta48784){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template48783.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_48785,meta48784__$1){
var self__ = this;
var _48785__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template48783(self__.opts,self__.id,self__.fn_to_element,meta48784__$1));
}));

(reagent.impl.template.t_reagent$impl$template48783.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_48785){
var self__ = this;
var _48785__$1 = this;
return self__.meta48784;
}));

(reagent.impl.template.t_reagent$impl$template48783.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template48783.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template48783.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template48783.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template48783.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta48784","meta48784",1514098586,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template48783.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template48783.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template48783");

(reagent.impl.template.t_reagent$impl$template48783.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write.call(null,writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template48783");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template48783.
 */
reagent.impl.template.__GT_t_reagent$impl$template48783 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template48783(opts__$1,id__$1,fn_to_element__$1,meta48784){
return (new reagent.impl.template.t_reagent$impl$template48783(opts__$1,id__$1,fn_to_element__$1,meta48784));
});

}

return (new reagent.impl.template.t_reagent$impl$template48783(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
