...
return [(function (){var pred__48880 = cljs.core.instance_QMARK_;
var expr__48881 = reactive_val;
if(cljs.core.truth_(pred__48880.call(null,reagent.ratom.RAtom,expr__48881))){
return "ra";
} else {
if(cljs.core.truth_(pred__48880.call(null,reagent.ratom.RCursor,expr__48881))){
return "rc";
} else {
if(cljs.core.truth_(pred__48880.call(null,reagent.ratom.Reaction,expr__48881))){
return "rx";
} else {
if(cljs.core.truth_(pred__48880.call(null,reagent.ratom.Track,expr__48881))){
return "tr";
} else {
return "other";
}
