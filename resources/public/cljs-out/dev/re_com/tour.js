...
return cljs.core.reduce.call(null,(function (p1__53149_SHARP_,p2__53150_SHARP_){
return cljs.core.assoc.call(null,p1__53149_SHARP_,p2__53150_SHARP_,reagent.core.atom.call(null,false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.call(null,(function (){var iter__4622__auto__ = (function re_com$tour$initialise_tour_$_iter__53151(s__53152){
return (new cljs.core.LazySeq(null,(function (){
var s__53152__$1 = s__53152;
while(true){
var temp__5753__auto__ = cljs.core.seq.call(null,s__53152__$1);
if(temp__5753__auto__){
var s__53152__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__53152__$2)){
var c__4620__auto__ = cljs.core.chunk_first.call(null,s__53152__$2);
var size__4621__auto__ = cljs.core.count.call(null,c__4620__auto__);
var b__53154 = cljs.core.chunk_buffer.call(null,size__4621__auto__);
if((function (){var i__53153 = (0);
while(true){
if((i__53153 < size__4621__auto__)){
var step = cljs.core._nth.call(null,c__4620__auto__,i__53153);
cljs.core.chunk_append.call(null,b__53154,cljs.core.reset_BANG_.call(null,step.call(null,tour),false));

var G__53155 = (i__53153 + (1));
i__53153 = G__53155;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__53154),re_com$tour$initialise_tour_$_iter__53151.call(null,cljs.core.chunk_rest.call(null,s__53152__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__53154),null);
}
} else {
var step = cljs.core.first.call(null,s__53152__$2);
return cljs.core.cons.call(null,cljs.core.reset_BANG_.call(null,step.call(null,tour),false),re_com$tour$initialise_tour_$_iter__53151.call(null,cljs.core.rest.call(null,s__53152__$2)));
}
} else {
return null;
}
...
return iter__4622__auto__.call(null,new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
})());
});
/**
