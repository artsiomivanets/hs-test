...
var o57261 = temp__5751__auto__;
var temp__5751__auto____$1 = (o57261["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o57262 = temp__5751__auto____$1;
return (o57262["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__30950__auto___57265 = t;
(o__30950__auto___57265["cljs$lang$ctorPrWriter"]).call(o__30950__auto___57265,t,writer);
}catch (e57264){var __57266 = e57264;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__57267 = num_code;
switch (G__57267) {
case (1):
return (185);
...
}catch (e57269){var _e__30957__auto__ = e57269;
return false;
}})())){
...
var vec__57270 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__57270,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var o57273 = temp__5751__auto__;
var temp__5751__auto____$1 = (o57273["dependencies_"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o57274 = temp__5751__auto____$1;
return (o57274["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4829__auto___57281 = arguments.length;
var i__4830__auto___57282 = (0);
while(true){
if((i__4830__auto___57282 < len__4829__auto___57281)){
args__4835__auto__.push((arguments[i__4830__auto___57282]));

var G__57283 = (i__4830__auto___57282 + (1));
i__4830__auto___57282 = G__57283;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__57277){
var vec__57278 = p__57277;
var ns_detector = cljs.core.nth.call(null,vec__57278,(0),null);
...
var G__57284 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__57285 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__57284;
remaining_tokens = G__57285;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq57275){
var G__57276 = cljs.core.first.call(null,seq57275);
var seq57275__$1 = cljs.core.next.call(null,seq57275);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57276,seq57275__$1);
}));
...
var vec__57289 = cljs.core.split_with.call(null,(function (p1__57288_SHARP_){
return cljs.core.not_EQ_.call(null,p1__57288_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__57289,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__57289,(1),null);
...
var vec__57295 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__57295,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__57295,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__57298 = cljs.core.rest.call(null,remaining_tokens);
var G__57299 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__57298;
name_tokens = G__57299;
continue;
} else {
...
var vec__57302 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__57302,(0),null);
var arity = cljs.core.nth.call(null,vec__57302,(1),null);
var vec__57305 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__57305,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__57305,(1),null);
var vec__57308 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__57308,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__57308,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__57308,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__57308,(3),null);
...
var vec__57314 = result;
var munged_ns = cljs.core.nth.call(null,vec__57314,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__57314,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__57314,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__57314,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__57314,(4),null);
var arity = cljs.core.nth.call(null,vec__57314,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__57318 = temp__5751__auto__;
var munged_name = cljs.core.nth.call(null,vec__57318,(0),null);
var args = cljs.core.nth.call(null,vec__57318,(1),null);
var vec__57321 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__57321,(0),null);
var name = cljs.core.nth.call(null,vec__57321,(1),null);
...
var G__57324 = (arity + (1));
var G__57325 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__57326){
var vec__57327 = p__57326;
var arity = cljs.core.nth.call(null,vec__57327,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__57327,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__57330_SHARP_){
return cljs.core.get.call(null,arities,p1__57330_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__57331_SHARP_){
return cljs.core.drop.call(null,(2),p1__57331_SHARP_);
}),sorted_infos);
...
var args__4835__auto__ = [];
var len__4829__auto___57338 = arguments.length;
var i__4830__auto___57339 = (0);
while(true){
if((i__4830__auto___57339 < len__4829__auto___57338)){
args__4835__auto__.push((arguments[i__4830__auto___57339]));

var G__57340 = (i__4830__auto___57339 + (1));
i__4830__auto___57339 = G__57340;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__57334){
var vec__57335 = p__57334;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__57335,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq57332){
var G__57333 = cljs.core.first.call(null,seq57332);
var seq57332__$1 = cljs.core.next.call(null,seq57332);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57333,seq57332__$1);
}));
...
var map__57343 = options;
var map__57343__$1 = cljs.core.__destructure_map.call(null,map__57343);
var include_ns_QMARK_ = cljs.core.get.call(null,map__57343__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__57343__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__57343__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__57343__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__57344 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__57344,(0),null);
var fn_name = cljs.core.nth.call(null,vec__57344,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__57344,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__57344,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__57344,(4),null);
var arity = cljs.core.nth.call(null,vec__57344,(5),null);
...
}catch (e57347){var _e__30957__auto__ = e57347;
...
var G__57348 = (obj[cljs.core.first.call(null,path)]);
var G__57349 = cljs.core.rest.call(null,path);
obj = G__57348;
path = G__57349;
continue;
} else {
...
var _STAR_ = (function (accum,p__57350){
var vec__57351 = p__57350;
var bit = cljs.core.nth.call(null,vec__57351,(0),null);
var protocol = cljs.core.nth.call(null,vec__57351,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__57354){
var vec__57355 = p__57354;
var ns = cljs.core.nth.call(null,vec__57355,(0),null);
var name = cljs.core.nth.call(null,vec__57355,(1),null);
var selector = cljs.core.nth.call(null,vec__57355,(2),null);
...
var post_process = (function (p__57359){
var vec__57360 = p__57359;
var munged_name = cljs.core.nth.call(null,vec__57360,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__57360,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__57358_SHARP_){
return (obj[cljs.core.first.call(null,p1__57358_SHARP_)]);
}),sorted_matches);
