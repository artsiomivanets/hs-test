...
var map__58521 = top_item;
var map__58521__$1 = cljs.core.__destructure_map.call(null,map__58521);
var file = cljs.core.get.call(null,map__58521__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__58521__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__58521__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e58520){var _e = e58520;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___58522 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5751__auto___58522)){
var seen_errors_58523 = temp__5751__auto___58522;
if(cljs.core.truth_(seen_errors_58523.has(self))){
} else {
seen_errors_58523.add(self);

var temp__5753__auto___58524 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5753__auto___58524)){
var sense_58525 = temp__5753__auto___58524;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_58525)].join(''));
} else {
}
}
} else {
