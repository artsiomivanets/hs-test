...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__52919 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,(function (p1__52918_SHARP_){
return cljs.core.subs.call(null,p1__52918_SHARP_,(0),(3));
}),G__52919);
} else {
return G__52919;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__52928){
var vec__52929 = p__52928;
var t = cljs.core.nth.call(null,vec__52929,(0),null);
var pattern = cljs.core.nth.call(null,vec__52929,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__52932 = pattern;
switch (G__52932) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52932)].join('')));
...
return p1__52934_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__52935_SHARP_){
return p1__52935_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__52936_SHARP_){
return p1__52936_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__52937_SHARP_){
return p1__52937_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__52938_SHARP_){
return p1__52938_SHARP_.getHours();
});

break;
case "day":
return (function (p1__52939_SHARP_){
return p1__52939_SHARP_.getDate();
});

break;
case "month":
return (function (p1__52940_SHARP_){
return p1__52940_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__52941_SHARP_){
return p1__52941_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52942__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__52944){
var vec__52945 = p__52944;
var seq__52946 = cljs.core.seq.call(null,vec__52945);
var first__52947 = cljs.core.first.call(null,seq__52946);
var seq__52946__$1 = cljs.core.next.call(null,seq__52946);
var key = first__52947;
var args = seq__52946__$1;
var G__52948 = key;
...
break;
case "ordinal-suffix":
var vec__52949 = syntax_list.call(null,(i - (1)));
...
var d = value;
var G__52956 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__52957 = G__52956;
var seq__52958 = cljs.core.seq.call(null,vec__52957);
var first__52959 = cljs.core.first.call(null,seq__52958);
var seq__52958__$1 = cljs.core.next.call(null,seq__52958);
var unparser = first__52959;
var more = seq__52958__$1;
var s = "";
var d__$1 = d;
var G__52956__$1 = G__52956;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__52966 = G__52956__$1;
...
var unparser__$1 = first__52968;
var more__$1 = seq__52967__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__52969 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__52969,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__52969,(1),null);
var G__52972 = d__$3;
var G__52973 = more__$1;
var G__52974 = s__$3;
d__$1 = G__52972;
G__52956__$1 = G__52973;
s__$1 = G__52974;
continue;
}
break;
